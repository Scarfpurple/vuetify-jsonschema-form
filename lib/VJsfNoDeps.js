...
export default {
  ...
  mounted() {
    ...
    this.$watch(watcher, () => {
      ...
      if (this.parentKey !== 'root') {
        fullSchema = schemaUtils.prepareFullSchema(this.resolvedSchema, this.modelRoot[this.parentKey], this.fullOptions)
      } else {
        fullSchema = schemaUtils.prepareFullSchema(this.resolvedSchema, this.modelRoot, this.fullOptions)
      }
  ...
  methods: {
    ...
    input(value, initial = false, fastForward = true) {
      ...
      /*  if (this.modelRoot) {
        const fullSchema = schemaUtils.prepareFullSchema(this.resolvedSchema, this.modelRoot, this.fullOptions)
        console.log('SCHEMA')
