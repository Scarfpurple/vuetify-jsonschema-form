...
export default {
  ...
  mounted() {
    ...
    this.$watch(watcher, () => {
      console.log(this.flattenObject(this.modelRoot))
  ...
  methods: {
    ...
    input(value, initial = false, fastForward = true) {
      ...
      const fullSchema = schemaUtils.prepareFullSchema(this.resolvedSchema, this.flatObjFn(this.modelRoot), this.fullOptions)
      console.log(this)
      console.log(this.modelRoot)
      // kinda hackish but prevents triggering large rendering chains when nothing meaningful changes
      if (!deepEqual(fullSchema, this.fullSchema)) this.fullSchema = fullSchema
